...
fig_c.tight_layout()
fig_c.savefig("plots/plot_C_prefill_cycles_vs_passes.png", dpi=150)
plt.close(fig_c)
...
fig_d.tight_layout()
fig_d.savefig("plots/plot_D_decode_vs_prefill_throughput.png", dpi=150)
plt.close(fig_d)
...
fig_e.tight_layout()
fig_e.savefig("plots/plot_E_per_pass_breakdown.png", dpi=150)
plt.close(fig_e)
...
fig_f.tight_layout()
fig_f.savefig("plots/plot_F_causal_savings_vs_passes.png", dpi=150)
plt.close(fig_f)
